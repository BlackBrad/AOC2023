...
all:
	...
	# Build the helper module for each day
	$(FC) $(FFLAGS) -c ./utils/day1_helpers.f90
	$(FC) $(FFLAGS) -c ./utils/day2_helpers.f90
	...
	$(FC) $(FFLAGS) $(REAL_INPUT) ./day2/day2.f90 ./file_helpers.o ./string_utils.o day2_helpers.o -o ./day2.out
